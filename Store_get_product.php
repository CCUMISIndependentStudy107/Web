    ...
    function FetchSQL($servername, $username, $password, $db_name, $tablename, $fieldName, $companyName) {
        ...
        if ($conn -> query($sql) == false) {
            ...
            for ($i = 0; $i < count($keys); $i++) {
                ...
                $modals .= "<div class=\"modal fade\" id=\"productDetailModal$i\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"productDetailModalTitle$i\" aria-hidden=\"true\"><div class=\"modal-dialog modal-xl modal-dialog-centered\" role=\"document\"><div class=\"modal-content\"><div class=\"modal-header\"><h5 class=\"modal-title\">更多資訊</h5><button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button></div><div class=\"modal-body\"><form id=\"product-details-$i\" class=\"row\"><div class=\"form-group col-sm-4 row\"><label for=\"name$i\" class=\"col-sm-4 col-form-label\">名稱</label><div class=\"col-sm-8\"><input type=\"text\" readonly class=\"form-control\" id=\"name$i\" value=\"".$arr[$keys[$i]][1]."\"></div></div><div class=\"form-group col-sm-4 row\"><label for=\"tag$i\" class=\"col-sm-4 col-form-label\">標籤</label><div class=\"col-sm-8\"><input type=\"text\" readonly class=\"form-control\" id=\"tag$i\" value=\"".$arr[$keys[$i]][6]."\"></div></div><div class=\"form-group col-sm-4 row\"><label for=\"reduceC$i\" class=\"col-sm-4 col-form-label\">節碳量</label><div class=\"col-sm-8\"><input type=\"text\" readonly class=\"form-control\" id=\"reduceC$i\" value=\"".$arr[$keys[$i]][8]." 克\"></div></div><div class=\"form-group col-sm-4 row\"><label for=\"price$i\" class=\"col-sm-4 col-form-label\">單價</label><div class=\"col-sm-8\"><input type=\"text\" readonly class=\"form-control\" id=\"price$i\" value=\"".$arr[$keys[$i]][2]." 元\"></div></div><div class=\"form-group col-sm-4 row\"><label for=\"quantity$i\" class=\"col-sm-4 col-form-label\">數量</label><div class=\"col-sm-8\"><input type=\"text\" readonly class=\"form-control\" id=\"quantity$i\" value=\"".$arr[$keys[$i]][3]."\"></div></div><div class=\"form-group col-sm-4 row\"><label for=\"weight$i\" class=\"col-sm-4 col-form-label\">重量</label><div class=\"col-sm-8\"><input type=\"text\" readonly class=\"form-control\" id=\"weight$i\" value=\"".$arr[$keys[$i]][5]." 克\"></div></div><div class=\"form-group col-sm-12 row\"><label for=\"information$i\" class=\"col-sm-1 col-form-label\">資訊</label><div class=\"col-sm-11\"><textarea readonly class=\"form-control\" id=\"information$i\">".$arr[$keys[$i]][4]."</textarea></div></div></form></div><div class=\"modal-footer justify-content-between\"><form class=\"row\" onsubmit=\"return purchaseProduct($i);\"><div class=\"form-group col row justify-content-around\"><label for=\"buyamount$i\" class=\"col-form-label col-4\">購買數量</label><div class=\"col\"><input type=\"text\" class=\"form-control\" id=\"buyamount$i\" required></div></div><div class=\"form-group\"><button type=\"submit\" class=\"btn btn-success\">送出</button></div></form><button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Close</button></div></div></div></div>";

...
<?php
    ...
    function Transaction($conn,$product){
        ...
        $fieldname = array("ID","CardID","ProductID","Price","Quantity","Time","Company","tx","Status");
        $sql = "CREATE TABLE IF NOT EXISTS $tablename (".$fieldname[0]." INT NOT NULL AUTO_INCREMENT PRIMARY KEY, ".$fieldname[1]." VARCHAR($card_length),".$fieldname[2]." INT,".$fieldname[3]." INT,".$fieldname[4]." INT,".$fieldname[5]." DATETIME,".$fieldname[6]." VARCHAR(100),".$fieldname[7]." VARCHAR(100),".$fieldname[8]." BOOLEAN DEFAULT 0)";
        echo $sql;

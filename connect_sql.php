<?php
    ...
    mysql_query("SET NAMES big5;", $db_link);   //utf8
    if (!$conn) die("Connection failed: " . mysqli_connect_error()."<br/>");    //not connected then die
    // else echo "Connection Success!";
    $sql = "CREATE DATABASE IF NOT EXISTS ".$db_name." DEFAULT CHARACTER SET big5 COLLATE big5_chinese_ci;";    //utf8 utf8_unicode_ci
